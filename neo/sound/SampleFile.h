 ...
 * SampleFile.h
 *
 *  Created on: 6 de gen. 2018
 *      Author: biel
 */

#ifndef NEO_SOUND_SAMPLEFILE_H_
#define NEO_SOUND_SAMPLEFILE_H_
...
enum
{
	FORMAT_UNKNOWN		= 0x0000, //0
	FORMAT_PCM			= 0x0001, //1
	FORMAT_ADPCM		= 0x0002, //2
	//FORMAT_VORBIS		= 0x0003, //3
	FORMAT_XMA2			= 0x0166, //358
	FORMAT_EXTENSIBLE	= 0xFFFF, //65535
};
